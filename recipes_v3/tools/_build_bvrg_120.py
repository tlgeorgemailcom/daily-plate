#!/usr/bin/env python3
"""Build script for BVRG_120 Sangria."""
import csv
...
recipes_row = {
    "recipe_id": ID, "food_word": "SANGRIA", "recipe_name": "Sangria",
    ...
    "audit_notes": (
        "Rule D — no canonical; red wine 4oz + brandy 1oz + OJ 1oz + "
        "lemon \u00bdoz + simple syrup \u00bdoz; ~208.9g ~104 kcal/100g"
    ),
    "skip_macros": "",
}
...
# red_wine_dry    4 oz:   4 × 29.4  = 117.60g
# brandy          1 oz:   1 × 27.8  =  27.80g
# orange_juice_raw 1 oz:  1 × 31.0  =  31.00g
# lemon_juice_raw ½ oz:  0.5 × 30.0 =  15.00g (1 tbsp)
# simple_syrup    ½ oz:  0.5 × 35.0 =  17.50g
#                               TOTAL = 208.90g
ing_rows = [
    [ID, 1, "red_wine_dry",     "4 oz",        117.60, "", "", "cocktail", "", "", "", ""],
    [ID, 2, "brandy",           "1 oz",          27.80, "", "", "cocktail", "", "", "", ""],
    [ID, 3, "orange_juice_raw", "1 oz",          31.00, "", "", "cocktail", "", "", "", ""],
...
steps = [
    (1, "Combine the red wine, brandy, orange juice, lemon juice, and simple syrup in a large pitcher."),
    (2, "Stir well to combine."),
    (3, "Refrigerate for at least 1 hour (or overnight) to allow the flavors to meld."),
    (4, "Serve over ice in a wine glass."),
    (5, "Suggestions (not included): Add sliced oranges, lemons, and apples to the pitcher. A splash of club soda per glass adds lightness."),
]
