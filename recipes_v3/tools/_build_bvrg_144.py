"""Build script for BVRG_144 Trinidad Sour."""
import csv
...
recipes_row = {
    "recipe_id": RECIPE_ID,
    "food_word": "TRINIDADSOUR",
    "recipe_name": "Trinidad Sour",
    "category": "cocktails",
    ...
    "status": "approved",
    "fingerprint": "",
    "sr_notes": "angostura bitters 1.5oz + orgeat 1oz + rye whiskey 0.5oz + lemon juice 0.75oz; 116.0g; vegan; Rule D",
    "disclosure": "",
    "audit_status": "PASS",
    "audit_notes": "",
    "skip_macros": "",
...
ingredients_rows = [
    {
        ...
        "ingredient_key": "angostura_bitters", "qty_display": "1 1/2 oz",
    ...
    },
    {
        ...
        "ingredient_key": "orgeat", "qty_display": "1 oz",
        "grams": "37.9", "grams_min": "", "grams_max": "",
        "section": "cocktail", "ingredient_group": "",
        "is_optional": "", "display_name_override": "", "cook_section": "",
    },
    {
        "recipe_id": RECIPE_ID, "row_order": "3",
        "ingredient_key": "rye_whiskey", "qty_display": "1/2 oz",
        "grams": "13.9", "grams_min": "", "grams_max": "",
        "section": "cocktail", "ingredient_group": "",
        "is_optional": "", "display_name_override": "", "cook_section": "",
    },
    {
...
instructions_rows = [
    [RECIPE_ID, "1", "Combine all ingredients in a cocktail shaker with ice."],
    [RECIPE_ID, "2", "Shake vigorously until well chilled."],
    [RECIPE_ID, "3", "Double strain into a chilled coupe or cocktail glass."],
    [RECIPE_ID, "4", "Suggestions (not included): Serve straight up with no garnish."],
]
...
print("Done — BVRG_144 Trinidad Sour appended.")
