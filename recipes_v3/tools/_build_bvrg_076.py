"""Build script for BVRG_076 — Kir Royale."""
import csv
...
# creme_de_cassis: ½ oz × 34.0g = 17.0g
ingredients_rows = [
    {
...
instructions = [
    (RECIPE_ID, "1", "Pour the crème de cassis into a chilled Champagne flute."),
    (RECIPE_ID, "2", "Slowly top with well-chilled Champagne, pouring gently down the side of the glass to preserve the bubbles."),
    (RECIPE_ID, "3", "Stir very lightly and serve immediately."),
    (RECIPE_ID, "4", "Suggestions (not included): Garnish with a single blackcurrant or a twist of lemon."),
]
