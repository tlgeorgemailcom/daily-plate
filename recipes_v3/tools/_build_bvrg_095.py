"""Build script for BVRG_095 Naked & Famous."""
import csv
...
# mezcal ¾ oz:          0.75 × 27.8  = 20.85g
# yellow_chartreuse ¾oz: 0.75 × 29.57 = 22.18g
# aperol ¾ oz:          0.75 × 29.57 = 22.18g
# lime_juice_raw ¾ oz:  0.75 × (242/8)= 22.69g

p = BASE / "recipes.csv"
append_csv(p, get_fieldnames(p), [{
    "recipe_id": RECIPE_ID, "food_word": "NAKEDFAMOUS",
    "recipe_name": "Naked & Famous", "category": "cocktails",
...
ingredients_rows = [
    ...
    {"recipe_id": RECIPE_ID, "row_order": "2", "ingredient_key": "yellow_chartreuse",
     "qty_display": "\u00be oz", "grams": "22.18", "grams_min": "", "grams_max": "",
     "section": "cocktail", "ingredient_group": "", "is_optional": "0",
     "display_name_override": "", "cook_section": ""},
    {"recipe_id": RECIPE_ID, "row_order": "3", "ingredient_key": "aperol",
     "qty_display": "\u00be oz", "grams": "22.18", "grams_min": "", "grams_max": "",
     "section": "cocktail", "ingredient_group": "", "is_optional": "0",
     "display_name_override": "", "cook_section": ""},
...
with open(p, "a", newline="", encoding="utf-8") as f:
    w = csv.writer(f)
    w.writerow((RECIPE_ID, "1", "Combine mezcal, yellow chartreuse, Aperol, and lime juice in a cocktail shaker with ice."))
    w.writerow((RECIPE_ID, "2", "Shake well until chilled."))
    w.writerow((RECIPE_ID, "3", "Double-strain into a chilled coupe glass."))
