#!/usr/bin/env python3
"""Build script for BVRG_119 Pabol de Galo."""
import csv
...
recipes_row = {
    "recipe_id": ID, "food_word": "PABOLDEGALO", "recipe_name": "Pabol de Galo",
    ...
    "audit_notes": (
        "Rule D — no canonical; cachaca 1\u00bdoz + sweet vermouth \u00beoz + "
        "Cynar \u00beoz + bitters 2 dashes; NDB 14810 cynar custom; ~89.6g"
    ),
    "skip_macros": "",
}
...
# cachaca         1½ oz:  1.5 × 27.8  = 41.70g
# sweet_vermouth  ¾ oz:   0.75 × 31.0 = 23.25g (ledger: 31.0)
# cynar           ¾ oz:   0.75 × 30.5 = 22.88g
# aromatic_bitters 2 dashes: 2 × 0.9  =  1.80g
#                               TOTAL = 89.63g
ing_rows = [
    [ID, 1, "cachaca",          "1\u00bd oz",  41.70, "", "", "cocktail", "", "", "", ""],
    [ID, 2, "sweet_vermouth",   "\u00be oz",   23.25, "", "", "cocktail", "", "", "", ""],
    [ID, 3, "cynar",            "\u00be oz",   22.88, "", "", "cocktail", "", "", "", ""],
    [ID, 4, "aromatic_bitters", "2 dashes",     1.80, "", "", "cocktail", "", "", "", ""],
]
...
steps = [
    (1, "Add the cacha\u00e7a, sweet vermouth, Cynar, and bitters to a mixing glass filled with ice."),
    (2, "Stir for 25\u201330 seconds until well chilled and diluted."),
    (3, "Strain into a rocks glass over a large ice cube."),
    (4, "Suggestions (not included): Garnish with a lime twist."),
]
