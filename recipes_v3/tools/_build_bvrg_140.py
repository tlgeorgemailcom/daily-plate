"""Build script for BVRG_140 Tipperary."""
import csv
...
recipes_row = {
    ...
    "status": "approved",
    "fingerprint": "",
    "sr_notes": "Irish whiskey 2oz + sweet vermouth 0.75oz + green chartreuse 0.75oz + bitters 2 dashes; 99.9g; vegan; Rule D",
    "disclosure": "",
    "audit_status": "PASS",
    "audit_notes": "",
    "skip_macros": "",
...
ingredients_rows = [
    {
        ...
        "ingredient_key": "irish_whiskey", "qty_display": "2 oz",
    ...
    },
    {
        ...
        "ingredient_key": "sweet_vermouth", "qty_display": "3/4 oz",
        "grams": "23.25", "grams_min": "", "grams_max": "",
        "section": "cocktail", "ingredient_group": "",
        "is_optional": "", "display_name_override": "", "cook_section": "",
    },
    {
        "recipe_id": RECIPE_ID, "row_order": "3",
        "ingredient_key": "green_chartreuse", "qty_display": "3/4 oz",
...
instructions_rows = [
    [RECIPE_ID, "1", "Add all ingredients to a mixing glass with ice."],
    [RECIPE_ID, "2", "Stir until well chilled, about 20 seconds."],
    [RECIPE_ID, "3", "Strain into a chilled cocktail glass."],
    [RECIPE_ID, "4", "Suggestions (not included): Garnish with an orange twist."],
]
...
print("Done — BVRG_140 Tipperary appended.")
