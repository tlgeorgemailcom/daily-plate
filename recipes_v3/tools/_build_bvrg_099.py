"""Build script for BVRG_099 Old Cuban."""
import csv
...
# dark_rum 1½ oz:        1.5 × 27.0  = 40.5g
# lime_juice_raw ¾ oz:   0.75 × 30.0 = 22.5g
# simple_syrup ¾ oz:     0.75 × 35.0 = 26.25g
# aromatic_bitters 2d:   2 × 0.9     = 1.8g
# mint_fresh 6 leaves:   6 × 0.3     = 1.8g
# sparkling_wine 2 oz:   2 × 29.4    = 58.8g

p = BASE / "recipes.csv"
append_csv(p, get_fieldnames(p), [{
    "recipe_id": RECIPE_ID, "food_word": "OLDCUBAN",
    "recipe_name": "Old Cuban", "category": "cocktails",
...
ingredients_rows = [
    {"recipe_id": RECIPE_ID, "row_order": "1", "ingredient_key": "dark_rum",
    ...
    {"recipe_id": RECIPE_ID, "row_order": "3", "ingredient_key": "simple_syrup",
     ...
     "section": "cocktail", "ingredient_group": "", "is_optional": "0",
     "display_name_override": "", "cook_section": ""},
    {"recipe_id": RECIPE_ID, "row_order": "4", "ingredient_key": "aromatic_bitters",
     "qty_display": "2 dashes", "grams": "1.8", "grams_min": "", "grams_max": "",
     "section": "cocktail", "ingredient_group": "", "is_optional": "0",
     "display_name_override": "", "cook_section": ""},
    {"recipe_id": RECIPE_ID, "row_order": "5", "ingredient_key": "mint_fresh",
     "qty_display": "6 leaves", "grams": "1.8", "grams_min": "", "grams_max": "",
     "section": "cocktail", "ingredient_group": "", "is_optional": "0",
     "display_name_override": "", "cook_section": ""},
    {"recipe_id": RECIPE_ID, "row_order": "6", "ingredient_key": "sparkling_wine",
     "qty_display": "2 oz", "grams": "58.8", "grams_min": "", "grams_max": "",
     "section": "cocktail", "ingredient_group": "", "is_optional": "0",
     "display_name_override": "", "cook_section": ""},
]
...
with open(p, "a", newline="", encoding="utf-8") as f:
    w = csv.writer(f)
    w.writerow((RECIPE_ID, "1", "Lightly muddle the mint leaves in a cocktail shaker."))
    w.writerow((RECIPE_ID, "2", "Add aged rum, lime juice, simple syrup, and bitters with ice."))
    w.writerow((RECIPE_ID, "3", "Shake well until chilled."))
    w.writerow((RECIPE_ID, "4", "Double-strain into a chilled coupe glass."))
    w.writerow((RECIPE_ID, "5", "Top with sparkling wine and gently stir to combine."))
    w.writerow((RECIPE_ID, "6", "Suggestions (not included): Garnish with a fresh mint sprig."))
print("✓ recipe_instructions.csv — 6 steps")
