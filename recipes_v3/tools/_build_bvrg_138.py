"""Build script for BVRG_138 TattleTale."""
import csv
...
recipes_row = {
    "recipe_id": RECIPE_ID,
    "food_word": "TATTLETALE",
    "recipe_name": "TattleTale",
    "category": "cocktails",
    ...
    "status": "approved",
    "fingerprint": "",
    "sr_notes": "blended scotch 1.25oz + islay scotch 0.75oz + honey syrup 1 barspoon + bitters 3 dashes; 65.1g; vegan; Rule D",
    "disclosure": "",
    "audit_status": "PASS",
    "audit_notes": "",
    "skip_macros": "",
...
ingredients_rows = [
    {
        ...
        "ingredient_key": "scotch_whisky", "qty_display": "1 1/4 oz",
        "grams": "34.75", "grams_min": "", "grams_max": "",
        "section": "cocktail", "ingredient_group": "",
        "is_optional": "", "display_name_override": "", "cook_section": "",
    },
    {
        "recipe_id": RECIPE_ID, "row_order": "2",
        "ingredient_key": "islay_scotch", "qty_display": "3/4 oz",
        "grams": "20.85", "grams_min": "", "grams_max": "",
        "section": "cocktail", "ingredient_group": "",
        "is_optional": "", "display_name_override": "", "cook_section": "",
    },
    {
        "recipe_id": RECIPE_ID, "row_order": "3",
        "ingredient_key": "honey_syrup", "qty_display": "1 barspoon (5 ml)",
        "grams": "6.8", "grams_min": "", "grams_max": "",
        "section": "cocktail", "ingredient_group": "",
        "is_optional": "", "display_name_override": "", "cook_section": "",
    },
    {
        "recipe_id": RECIPE_ID, "row_order": "4",
        "ingredient_key": "angostura_bitters", "qty_display": "3 dashes",
        "grams": "2.7", "grams_min": "", "grams_max": "",
        "section": "cocktail", "ingredient_group": "",
        "is_optional": "", "display_name_override": "", "cook_section": "",
    },
]
...
instructions_rows = [
    [RECIPE_ID, "1", "Add the blended Scotch, Islay Scotch, honey syrup, and bitters to a mixing glass with ice."],
    [RECIPE_ID, "2", "Stir until well chilled, about 20 seconds."],
    [RECIPE_ID, "3", "Strain into a chilled rocks glass over a large ice cube."],
    [RECIPE_ID, "4", "Express a lemon peel and an orange peel over the glass, then drop in as garnish."],
]
...
print("Done — BVRG_138 TattleTale appended.")
