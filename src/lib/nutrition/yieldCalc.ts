...
export const BINDING: Record<string, number> = {
  ...
  sauteed_aromatic:  0.127, // moderate-heat sauteed aromatics (garlic, onion, shallot, sofrito, sliced mushrooms)
                            // 200°F×2min → yfw≈0.956; 200°F×9min → yfw≈0.892. Not for larger vegetable pieces.
  ...
  pan_grilled_chicken: 0.216, // pan-seared chicken breast (230°F×11min → yfw≈0.795)
                              // NDB 5062 (raw) / NDB 5063 (fried) USDA pair
  pan_grilled_steak:   0.272, // pan-seared thin steak (230°F×7min → yfw≈0.768)
