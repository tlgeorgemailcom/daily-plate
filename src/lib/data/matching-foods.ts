...
export const MATCHING_FOODS: MatchingFood[] = [
  ...
  { word: 'MEATLOAF', display: 'Meatloaf', containers: ['plate'], meals: ['dinner'] },
  ...
  { word: 'LAMB', display: 'Lamb', containers: ['plate'], meals: ['dinner'] },
  ...
  { word: 'MOZZARELLA', display: 'Mozzarella', containers: ['saucer', 'plate'], meals: ['snack', 'lunch'] },
  ...
  { word: 'CHEESECAKE', display: 'Cheesecake', containers: ['saucer'], meals: ['snack'] },
