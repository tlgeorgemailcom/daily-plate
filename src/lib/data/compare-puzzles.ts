...
export const COMPARE_PUZZLES: ComparePuzzle[] = [
  ...
  {
    id: 'puzzle-006',
    imageA: '/images/compare/puzzle-006-a.jpg',
    imageB: '/images/compare/puzzle-006-b.jpg',
    differences: [
      { x: 31, y: 65, radius: 8 },  // Difference 1
      { x: 50, y: 57, radius: 8 },  // Difference 2
      { x: 91, y: 58, radius: 8 },  // Difference 3
      { x: 16, y: 45, radius: 8 },  // Difference 4
    ]
  },
  {
    id: 'puzzle-007',
  ...
  {
    id: 'puzzle-008',
    imageA: '/images/compare/puzzle-008-a.jpg',
    imageB: '/images/compare/puzzle-008-b.jpg',
    differences: [
      { x: 60, y: 67, radius: 8 },  // Difference 1
      { x: 77, y: 41, radius: 8 },  // Difference 2
      { x: 39, y: 86, radius: 8 },  // Difference 3
      { x: 10, y: 65, radius: 8 },  // Difference 4
    ]
  },
  {
    id: 'puzzle-10',
    imageA: '/images/compare/puzzle-10-a.jpg',
    imageB: '/images/compare/puzzle-10-b.jpg',
    differences: [
      { x: 51, y: 50, radius: 8 },  // Difference 1
      { x: 13, y: 36, radius: 8 },  // Difference 2
      { x: 82, y: 88, radius: 8 },  // Difference 3
      { x: 12, y: 71, radius: 8 },  // Difference 4
    ]
  },
  {
    id: 'puzzle-009',
    imageA: '/images/compare/puzzle-009-a.jpg',
    imageB: '/images/compare/puzzle-009-b.jpg',
    differences: [
      { x: 84, y: 31, radius: 8 },  // Difference 1
      { x: 23, y: 40, radius: 8 },  // Difference 2
      { x: 10, y: 53, radius: 8 },  // Difference 3
      { x:  3, y: 91, radius: 8 },  // Difference 4
    ]
  }
];
