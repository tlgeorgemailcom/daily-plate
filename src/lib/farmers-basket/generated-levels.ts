...
export const LEVELS: Level[] = [
  ...
  },
  {
    ...
    recipeIngredients: [
      ...
      { name: 'ground beef', quantity: '1½ oz raw beef', section: 'beef', ndbNo: '23572', portionDesc: 'g', portionGrams: 45.0 },
      { name: 'flour tortilla', quantity: '1 large flour tortilla', section: 'assembly', ndbNo: '18364', portionDesc: 'g', portionGrams: 60.0 },
      { name: 'water', quantity: '10g water', section: 'assembly', ndbNo: '14411', portionDesc: 'g', portionGrams: 10.0 },
      { name: 'Mexican cheese blend', quantity: '1 tbsp', section: 'assembly', ndbNo: '1251', portionDesc: 'g', portionGrams: 5.0 }
    ],
    recipeInstructions: [
      'Cook the ground beef in a skillet over medium-high heat, breaking it apart, until browned and no longer pink, about 5–7 minutes. Drain off any excess fat.',
