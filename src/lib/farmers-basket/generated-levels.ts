...
export const LEVELS: Level[] = [
  ...
  },
  {
    ...
    recipeIngredients: [
      ...
      { name: 'boiled potato (shredded)', quantity: '2 medium', section: 'hashbrown', ndbNo: '11367', portionDesc: 'g', portionGrams: 225.0 },
    ...
    recipeInstructions: [
      'Place the potatoes in a saucepan, cover with cold water, and bring to a boil. Cook until just tender when pierced with a fork, about 15–18 minutes. Drain, let cool slightly, then peel and coarsely shred.',
