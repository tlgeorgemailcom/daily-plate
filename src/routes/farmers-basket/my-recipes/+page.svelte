  ...
  async function handleSaveEdit(data: RecipeFormData) {
    ...
    try {
      ...
      const updates: Record<string, unknown> = {
        ...
        fillClass: data.fillClass || null,
        cook2Method: data.cook2Method || null,
        cook2Minutes: data.cook2Minutes ?? null,
        cook2TempF: data.cook2TempF ?? null,
        cook2FillClass: data.cook2FillClass || null,
        cook3Method: data.cook3Method || null,
        cook3Minutes: data.cook3Minutes ?? null,
        cook3TempF: data.cook3TempF ?? null,
        cook3FillClass: data.cook3FillClass || null,
      ...
      <div class="edit-content">
        ...
        {#key editingRecipe.id}
          <RecipeForm
            ...
            fillClass: typeof (editingRecipe as any).fillClass === 'string' ? (editingRecipe as any).fillClass : undefined,
