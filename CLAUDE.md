...
| `SAND_NNN` | 🔧 In progress | 64 (001–064) |
...
| SAND_064 | Chicago Style Hot Dog | (none) | Rule D ✅ — 2 sections: frank (grilled, yfw=1.00): frankfurter_beef(7022); assembly (raw): hamburger_bun(18350)+mustard_yellow(2046)+pickle_relish_sweet(11945)+tomato_red_raw(11529)+pickle_dill(11937)+peppers_hot_pickled(31034)+celery_seed(2007)+salt_table(2047); yfw=1.00 → 221.7g; 315 kcal/serving; 142.3 kcal·5.0P·7.1F·14.9C per 100g; dietary_category=all; food_word=CHICAGOSTYLEHOTDOG; grilled |
