...
| `SIDE_NNN` | 🔧 In progress | 20 (001–020) |
...
| SIDE_019 | Mac and Cheese | (none) | Rule D ✅ — no canonical; 2-section: pasta (boiled yfw=0.2541): pasta_dry_unenriched(20420) 244.0g+water(14411) 1000.0g→480g cooked; sauce (boiled yfw=0.90): butter_unsalted(1145) 42.6g+flour_ap_white_enriched_unbleached(20581) 23.4g+milk_whole(1077) 488.0g+cheese_cheddar(1009) 170.0g+salt_table(2047) 6.0g+white_pepper_ground(2032) 0.6g; 1161g cooked; 6 servings × 193.5g (¾ cup); 196.6 kcal·7.66P·9.56F·19.74C per 100g; dietary_category=veggie; yfw=0.2541 calibrated: 244g dry+1000g water→480g cooked (2 cups dry elbows→4 cups cooked); NDB 20420 and 20521 are unrelated USDA products (not a matched dry/cooked pair) |
| SIDE_020 | Mac and Tomato | (none) | Rule D ✅ — no canonical; 2-section: pasta (boiled yfw=0.2541): pasta_dry_unenriched(20420) 244.0g+water(14411) 1000.0g→480g cooked; mac_tomato (boiled yfw=0.95): tomatoes_canned_crushed(11693) 411.0g+butter_salted(1001) 28.4g+salt_table(2047) 3.0g+black_pepper_ground(2030) 0.575g→418g cooked; 905g cooked; 4 servings × 226.3g (1 cup); 137.2 kcal·4.29P·3.08F·23.48C per 100g; dietary_category=veggie |
## Current Work: SAND Recipes
...
- **Dry pasta + water is the correct model for boiled pasta recipes**: Always use the dry NDB (e.g. NDB 20420) + water as the boiling medium, not a pre-cooked NDB. Calibrate `yfw` so the pasta section produces the expected cooked weight: `yfw = retained_water / total_raw_water`, where retained water = target_cooked_weight − dry_non_water_mass. For elbow macaroni: 244g dry (NDB 20420) + 1000g water → 480g cooked; `yfw = (480 − 244×0.901) / (1000 + 244×0.099) = 260.3 / 1024.2 = 0.2541`. NDB 20420 (dry) and NDB 20521 (cooked) are **not** a matched dry/cooked pair — USDA measured different product samples (fatty acid gains on "cooking" prove this). Do NOT use pre-cooked NDBs for ingredients a cook would prepare from dry.
